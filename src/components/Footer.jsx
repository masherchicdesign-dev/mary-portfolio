...
<span>© 2026 Masha Osadcha</span>
        <div className="flex gap-5">
          <a href="https://drive.google.com/file/d/1dDAI3Iu0gBHoXuC_p20IMbznZ34QM5BX/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
            CV
          </a>
          <a
