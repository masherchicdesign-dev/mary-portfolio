const projects = [
  ...
  },
  {
    ...
    subtitle: 'AIR MEDIA-TECH',
    website: 'https://air.io/en',
    metric: 'Case in progress',
    image: '/cases/creators-ecosystem.png',
    description: 'At AIR Media-Tech, I initiated and led the 0→1 redesign of the personal platform for 3,000+ YouTube creators. Through deep user research, churn analysis, and lifecycle strategy, I turned a neglected platform into the strategic foundation for a 30+ product ecosystem defining UX architecture that aligned product strategy with creator value delivery.',
    period: '2024–2026',
  ...
  },
  {
    ...
    comingSoon: true,
    description: 'At OXYS, I conducted a UX audit of a technical prototype and redesigned 3 AI tools for YouTube creators from scratch: Comments Analyzer, Metadata Lab, and Idea Generator, managing a designer through task allocation, design reviews, and 1:1s, and shipping an AI toolkit later integrated into the MyAIR ecosystem.',
    period: '2024–2026',
    tools: 'Figma, AI, Miro, Google Sheets',
    keywords: 'Leadership, 0→1, AI UX, design system, OAuth flows, payment UX, ecosystem design, full cycle design',
  },
  {
    ...
    comingSoon: true,
    description: 'Led design on AIMDT: owned the project roadmap, managed a designer through task setting, design reviews, and quality feedback, while delivering a 0→1 product from a single wireframe to production.',
    period: '2023–2024',
    tools: 'Figma, AI',
    keywords: 'design leadership, mentorship, full cycle design',
  },
  {
    slug: 'royalty',
    ...
    comingSoon: true,
    description: 'At AIR Media-Tech, I designed Royalty from scratch: a blockchain marketplace for tokenizing YouTube channel revenue. With no direct competitors, I owned the full design process from domain research and IA to design system and QA. The product launched as a closed MVP for internal partners.',
    period: '2022–2026',
    tools: 'Figma, Miro',
